...
function addProcess(promise) {
  ...
  .then(function (schema) {
    ...
    var create = stp.importSchema(schema, ['provider_business_practice_location_address_postal_code','provider_last_name_legal_name',['provider_business_practice_location_address_postal_code','provider_last_name_legal_name']]),
        deferred = Q.defer(),
